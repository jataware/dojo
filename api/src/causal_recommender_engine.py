...
# os.environ['TRANSFORMERS_CACHE'] = "/api/big_models_data_cache"
...
class CausalRecommender:
    ...
    def __init__(self, model_name='gpt2-xl', device=None):
        ...
        self.generator = pipeline('text-generation', model=os.environ['TRANSFORMERS_CACHE']+"/models--gpt2-xl/snapshots/33cdb5c0db5423c1879b1b9f16c352988e8754a8", device=device)

        # self.generator.save_pretrained(os.environ['TRANSFORMERS_CACHE'])
...
recommender_engine = CausalRecommender(device='cpu')


# NOTE Demo of this working
