...
Dojo ([https://github.com/jataware/dojo](https://github.com/jataware/dojo)) is a suite of software tools that enables domain experts to do three things:
...
<CenteredImage width="700px" file="landing-page.png" title="Dojo Landing Page" />

## Contents

1. [Model Registration](./model-registration.md)
2. [Data Registration](./data-registration.mdx)
3. [Model Execution](./model-execution.mdx)
...
<CenteredImage width="700px" file="containerization_environment_medium.png" title="Dojo Containerization Environment" />
...
<CenteredImage width="500px" file="causemos_viz.png" title="Uncharted's Causemos Platform" />
...
This tool enables users to upload and search through large numbers of documents. Once documents are in the system, they can also be queried in plain language with the AI Assistant.
