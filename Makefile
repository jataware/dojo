...
.PHONY: docker_build
docker_build: docker_build-phantom  ## Build all docker containers
...
docker_push-dockerhub: docker_push-phantom | docker_login-dockerhub  ## Push all containers to docker registry
