...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src={DojoLogo}  width="300px" height="300px" />
</div>
...
![Dojo Containerization Environment](/img/containerization_environment_medium.png)
...
![Uncharted's Causemos Platform](/img/causemos_viz.png)
