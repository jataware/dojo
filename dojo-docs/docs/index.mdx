...
import DojoLogo from '@site/static/img/Dojo_Logo_profile.png';
import CenteredImage from '@site/src/components/CenteredImage';

<CenteredImage width="300px" src={DojoLogo} />
...
import LandingPage from '@site/static/img/landing-page.png';

<CenteredImage width="700px" src={LandingPage} title="Dojo Landing Page" />
...
import ContainerizationEnv from '@site/static/img/containerization_environment_medium.png';

<CenteredImage width="700px" src={ContainerizationEnv} title="Dojo Containerization Environment" />
...
import CausemosViz from '@site/static/img/causemos_viz.png';

<CenteredImage width="500px" src={CausemosViz} title="Uncharted's Causemos Platform" />
